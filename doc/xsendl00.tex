...
V tabulce \ref{tab1} je zobrazena závislot mezi poètem prvkù urèených k seøazení a èasem potøebným k jejich seøazení. Výsledky byly zji¹tìny pøi experimentování s posloupnostmi rùzných délek.
\begin{table}[ht]
\begin{center}
\begin{tabular}{ l | c c c c c c c c c c} 
%\rowcolor[gray]{0.9}
\hline
\textbf{poèet prvkù}	& 2 & 4 & 8 & 16 & 32 & 64 & 128 & 256 & 512 & 1024\\
\textbf{èas[s]}		&   &   &   &    &    &    &     &     &     &\\ \hline
\end{tabular}
